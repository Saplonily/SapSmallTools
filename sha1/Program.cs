...
public class Program
{
    ...
    {
        var rootCmd = new RootCommand("sha1 calculator of SapSmallTools.");
        var fileOptions = new Option<FileInfo?>("-f", "The file to be caculated sha1.");
        var textOptions = new Option<string>("-t", "The text to be caculated sha1.");
